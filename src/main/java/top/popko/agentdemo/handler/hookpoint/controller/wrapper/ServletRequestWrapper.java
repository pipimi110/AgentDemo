...
//public class ServletRequestWrapper implements DongTaiRequest {
...
//    public ServletRequestWrapper(HttpServletRequest request) {
    public ServletRequestWrapper(Object request) {
//        super(request);
...
//    }
    ...
    public String getRequestInfo(String methodName){
        try {
...
//        requestMeta.put("contextPath", this.getContextPath());
        requestMeta.put("contextPath", getRequestInfo("getContextPath"));
//        requestMeta.put("servletPath", this.getServletPath());
        requestMeta.put("servletPath", getRequestInfo("getServletPath"));
//        requestMeta.put("requestURL", this.getRequestURL());
        requestMeta.put("requestURL", getRequestInfo("getRequestURL"));
//        requestMeta.put("requestURI", this.getRequestURI());
        requestMeta.put("requestURI", getRequestInfo("getRequestURI"));
//        requestMeta.put("method", this.getMethod());
        requestMeta.put("method", getRequestInfo("getMethod"));
...
//        requestMeta.put("queryString", this.getQueryString());
        requestMeta.put("queryString", getRequestInfo("getQueryString"));
