...
public class Signature {
    ...
    public static Signature parse(String sign) {
        ...
        if (parametersStartIndex <= 2 || parametersEndIndex <= 3 || parametersStartIndex > parametersEndIndex || parametersEndIndex != sign

                .length() - 1) {
            throw new IllegalArgumentException("signature is invalid: " + sign);
        }
